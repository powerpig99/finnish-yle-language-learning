...
var YLEAdapter = {
     ...
     */
    getSubtitleWrapper() {
        const primary = document.querySelector(this.SELECTORS.subtitlesWrapper);
        if (primary)
            return primary;
        const playerUI = document.querySelector(this.SELECTORS.playerUI);
        ...
        return (scope.querySelector('[data-testid*="subtitles"]') ||
            ...
            scope.querySelector('[class*="Subtitle"]'));
    },
    /**
    ...
    getControlBarHTML(options = {}) {
        const { dualSubEnabled = false, autoPauseEnabled = false, playbackSpeed = 1 } = options;
        return `
...
//# sourceMappingURL=yle-adapter.js.map